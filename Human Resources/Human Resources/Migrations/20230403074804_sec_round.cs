...
{
    /// <inheritdoc />
    public partial class sec_round : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Promotions_Positions_fromPositionId",
                        column: x => x.fromPositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Promotions_Positions_toPositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotions_fromPositionId",
                table: "Promotions",
                column: "fromPositionId");

            migrationBuilder.CreateIndex(
                name: "IX_Promotions_toPositionId",
                table: "Promotions",
                column: "toPositionId");
